...
IMAGE_RE = re.compile(r"^[ ]*image: (?P<url>[a-zA-Z0-9./_-]*):(?P<tag>[0-9a-z.-]*)@sha256:(?P<digest>[a-z0-9]{64})[ ]*(?:#[ ]*target:[ ]*(?P<target>[a-zA-Z0-9]*))?$", re.MULTILINE) # I know that this is cursed. Just plop in into regex101.com to see what it's doing (Select Python on the left)
